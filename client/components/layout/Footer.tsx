      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              ThriftX is a premium marketplace for pre-loved fashion. 
              We connect conscious shoppers with verified vendors to promote 
              sustainable fashion and reduce waste.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPinIcon className="w-5 h-5 text-primary-500 mr-3 mt-1" />
                <span className="text-gray-400">
                  123 Thrift Street, Fashion District<br />
                  New York, NY 10001
                </span>
              </li>
              <li className="flex items-center">
                <PhoneIcon className="w-5 h-5 text-primary-500 mr-3" />
                <a 
                  href="tel:+1234567890" 
                  className="text-gray-400 hover:text-white transition-colors"
                >
              ...
              <li className="flex items-center">
                <MailIcon className="w-5 h-5 text-primary-500 mr-3" />
                <a 
                  href="mailto:info@thriftx.com" 
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  info@thriftx.com
                </a>
        ...
        <div className="border-t border-gray-800 pt-8 pb-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">
              Stay updated with the latest arrivals, exclusive offers, and sustainable fashion tips.
            </p>
            <form className="flex flex-col sm:flex-row gap-4">
              <input 
                type="email" 
                placeholder="Enter your email" 
                className="bg-gray-800 border border-gray-700 rounded-md px-4 py-2 text-white flex-grow focus:outline-none focus:ring-2 focus:ring-primary-500"
                required
              />
              <button 
                type="submit" 
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} ThriftX. All rights reserved.
          </p>
...
const categoryLinks = [
  ...
  { label: 'Vintage', path: '/products?category=vintage' },
  { label: 'Designer', path: '/products?category=designer' },
  { label: 'Sustainable', path: '/products?category=sustainable' },
];
